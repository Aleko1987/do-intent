...
var ClerkRuntimeError = (_b = class extends ClerkError {
  constructor(message, options) {
    ...
    */
    ...
    Object.setPrototypeOf(this, _b.prototype);
  }
}, __publicField(_b, "kind", "ClerkRuntimeError"), _b);
...
createContextAndHook("AuthContext");
...
var CustomPortalsRenderer = (props) => {
  var _a2, _b2;
  return /* @__PURE__ */ React.createElement(React.Fragment, null, (_a2 = props == null ? void 0 : props.customPagesPortals) == null ? void 0 : _a2.map((portal, index) => reactExports.createElement(portal, { key: index })), (_b2 = props == null ? void 0 : props.customMenuItemsPortals) == null ? void 0 : _b2.map((portal, index) => reactExports.createElement(portal, { key: index })));
};
withClerk(
...
const versionSelector = (clerkJSVersion, packageVersion = "5.123.0") => {
...
const clerkJsScriptUrl = (opts) => {
  ...
  else if (domain && !isDevOrStagingUrl(((_a2 = parsePublishableKey(publishableKey)) == null ? void 0 : _a2.frontendApi) || "")) scriptHost = addClerkPrefix(domain);
  else scriptHost = ((_b2 = parsePublishableKey(publishableKey)) == null ? void 0 : _b2.frontendApi) || "";
...
var _IsomorphicClerk = class _IsomorphicClerk2 {
  constructor(options) {
    ...
    this.hydrateClerkJS = (clerkjs) => {
      ...
      (_b2 = __privateGet(this, _eventBus).internal.retrieveListeners("queryClientStatus")) == null ? void 0 : _b2.forEach((listener) => {
...
((content2) => {
  class ServiceClient {
    ...
    async deleteItem(params) {
      await this.baseClient.callTypedAPI(`/content/items/${encodeURIComponent(params.id)}`, { method: "DELETE", body: void 0 });
    }
    /**
     * Lists all content items.
     */
    async list() {
      const resp = await this.baseClient.callTypedAPI(`/content/items`, { method: "GET", body: void 0 });
      return JSON.parse(await resp.text(), dateReviver);
    }
    /**
     * Logs a content post to a channel.
     */
    async logPost(params) {
      const body = {
  ...
  content2.ServiceClient = ServiceClient;
})(content || (content = {}));
var intent_scorer;
((intent_scorer2) => {
  class ServiceClient {
    ...
    async listLeadRollups(params) {
      const resp = await this.baseClient.callTypedAPI(`/intent-scorer/lead-rollups`, { method: "POST", body: JSON.stringify(params) });
      return JSON.parse(await resp.text(), dateReviver);
    }
    async listRules() {
      const resp = await this.baseClient.callTypedAPI(`/intent-scorer/rules`, { method: "GET", body: void 0 });
      return JSON.parse(await resp.text(), dateReviver);
    }
    async recomputeScores(params) {
      const resp = await this.baseClient.callTypedAPI(`/intent-scorer/recompute`, { method: "POST", body: JSON.stringify(params) });
      return JSON.parse(await resp.text(), dateReviver);
    }
    async seedDemo() {
      const resp = await this.baseClient.callTypedAPI(`/intent-scorer/seed-demo`, { method: "POST", body: void 0 });
      return JSON.parse(await resp.text(), dateReviver);
    }
  ...
  intent_scorer2.ServiceClient = ServiceClient;
...
((marketing2) => {
  class ServiceClient {
     ...
     */
    async getWithEvents(params) {
      const resp = await this.baseClient.callTypedAPI(`/marketing/leads/${encodeURIComponent(params.id)}/events`, { method: "GET", body: void 0 });
      return JSON.parse(await resp.text(), dateReviver);
    }
    /**
    ...
    async list(params) {
      ...
      const resp = await this.baseClient.callTypedAPI(`/marketing/leads`, { query, method: "GET", body: void 0 });
      return JSON.parse(await resp.text(), dateReviver);
    }
    /**
...
const clientTarget = "https://do-intent.onrender.com";
new Client(clientTarget, { requestInit: { credentials: "include" } });
{
