...
export async function ready(opts) {
    const params = undefined;
    if (typeof ENCORE_DROP_TESTS === "undefined" && process.env.NODE_ENV === "test") {
        return TEST_ENDPOINTS.ready(params, opts);
    }

    return apiCall("intent_scorer", "ready", params, opts);
}
export async function readyV1(opts) {
    const params = undefined;
    if (typeof ENCORE_DROP_TESTS === "undefined" && process.env.NODE_ENV === "test") {
        return TEST_ENDPOINTS.readyV1(params, opts);
    }
...
export async function trackOptions(opts) {
    const params = undefined;
    if (typeof ENCORE_DROP_TESTS === "undefined" && process.env.NODE_ENV === "test") {
        return TEST_ENDPOINTS.trackOptions(params, opts);
    }

    return apiCall("intent_scorer", "trackOptions", params, opts);
}
export async function trackGet(opts) {
    const params = undefined;
    if (typeof ENCORE_DROP_TESTS === "undefined" && process.env.NODE_ENV === "test") {
        return TEST_ENDPOINTS.trackGet(params, opts);
    }

    return apiCall("intent_scorer", "trackGet", params, opts);
}
export async function trackV1(opts) {
    const params = undefined;
    if (typeof ENCORE_DROP_TESTS === "undefined" && process.env.NODE_ENV === "test") {
        return TEST_ENDPOINTS.trackV1(params, opts);
    }

    return apiCall("intent_scorer", "trackV1", params, opts);
}
export async function trackV1Options(opts) {
    const params = undefined;
    if (typeof ENCORE_DROP_TESTS === "undefined" && process.env.NODE_ENV === "test") {
        return TEST_ENDPOINTS.trackV1Options(params, opts);
    }
